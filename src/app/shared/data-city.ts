...
export const regions = [
  ...
  },
  {
    ...
    name: 'Київська',
    cities: [
      { id: 0, name: 'Баришівка', postalCode: '7500' },
      { id: 1, name: 'Березань', postalCode: '7543' },
      { id: 2, name: 'Біла Церква', postalCode: '9100' },
      { id: 3, name: 'Богуслав', postalCode: '9700' },
      { id: 4, name: 'Бориспіль', postalCode: '8318' },
      { id: 5, name: 'Бородянка', postalCode: '7800' },
      { id: 6, name: 'Боярка', postalCode: '8157' },
      { id: 7, name: 'Бровари', postalCode: '7400' },
      { id: 8, name: 'Буча', postalCode: '8295' },
      { id: 9, name: 'Васильків', postalCode: '8612' },
      { id: 10, name: 'Велика Димерка', postalCode: '7442' },
      { id: 11, name: 'Вишгород', postalCode: '7304' },
      { id: 12, name: 'Вишневе', postalCode: '8134' },
      { id: 13, name: 'Глеваха', postalCode: '8630' },
      { id: 14, name: 'Гостомель', postalCode: '8291' },
      { id: 15, name: 'Іванків', postalCode: '7200' },
      { id: 16, name: 'Ірпінь', postalCode: '8289' },
      { id: 17, name: 'Кагарлик', postalCode: '9205' },
      { id: 18, name: 'Коцюбинське', postalCode: '8299' },
      { id: 19, name: 'Крюківщина', postalCode: '8136' },
      { id: 20, name: 'Макарів', postalCode: '8002' },
      { id: 21, name: 'Миронівка', postalCode: '8804' },
      { id: 22, name: 'Обухів', postalCode: '8705' },
      { id: 23, name: 'Переяслав', postalCode: '8409' },
      { id: 24, name: 'Ржищів', postalCode: '9231' },
      { id: 25, name: 'Рокитне', postalCode: '9600' },
      { id: 26, name: 'Сквира', postalCode: '9003' },
      { id: 27, name: 'Славутич', postalCode: '7199' },
      { id: 28, name: 'Ставище', postalCode: '9400' },
      { id: 29, name: 'Тараща', postalCode: '9504' },
      { id: 30, name: 'Тетіїв', postalCode: '9804' },
