...
@Component({
  selector: 'app-housing-subscriptions',
  templateUrl: './housing-subscriptions.component.html',
  styleUrls: ['./housing-subscriptions.component.scss'],
})
export class HousingSubscriptionsComponent implements OnInit {
